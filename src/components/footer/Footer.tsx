...
export default function Footer({lang}: {lang: string}) {
  ...
  return (
    <footer className="footer theme-bg border-t theme-border">
      <div className="footer-inner">
        ...
        <div className="footer-social">
          ...
          <div className="footer-social-links">
            {SOCIAL_LINKS.map(({id, href, ariaLabel}) => (
              <a
                key={id}
                href={href}
                target="_blank"
        ...
        <div className="footer-links">
          ...
          <Link href={`/${lang}/consultations/birth-chart`} className="footer-link">
            Birth Chart
          </Link>
          <Link href={`/${lang}/free-chart`} className="footer-link">
            Free Chart
          </Link>
        </div>
