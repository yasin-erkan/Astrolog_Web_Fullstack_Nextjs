...
export async function generateMetadata({params}: {params: Promise<{lang: string}>}) {
  ...
  const page = (locale as {freeChartPage?: {metaTitle?: string; metaDescription?: string}}).freeChartPage;
  return {
    title: page?.metaTitle ?? 'Free Chart | Astrolog Umran',
    description: page?.metaDescription ?? undefined,
  };
}

export default async function FreeChartPage({
  params,
}: {
